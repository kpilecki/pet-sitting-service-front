...
const UpdateInput = ( { inputLabel, inputPlaceholder, inputHasError, inputError,
    ...
    return (
            <div className="bg-light rounded mb-2">
                ...
                <button className="btn btn-sm btn-warning float-end" onClick={ toggleInputField }>{ buttonText }</button>
                <div className={ isInputHidden ? "col-12 mb-3 visually-hidden" : "col-12 mb-3"}>
                    <Input
                        ...
                        error={ inputError }
                    />
                    <button className="btn btn-sm btn-danger" onClick={ onClickUpdate }>Update</button>
                </div>
            </div>
